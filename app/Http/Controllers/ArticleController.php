...
class ArticleController extends Controller implements HasMiddleware
{
    ...
    {
        // Elimina tutti gli articoli con stato "rifiutato"
        Article::where('is_accepted', 0)->delete();

        return redirect()->back()->with('success', 'Tutti gli articoli rifiutati sono stati eliminati.');
    }
